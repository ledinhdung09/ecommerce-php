...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 13, 2024 lúc 07:27 PM
...
CREATE TABLE `admins` (
  ...
  `role` enum('Admin','User') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Admin',
...
INSERT INTO `admins` (`id`, `name`, `email`, `password`, `remember_token`, `phone`, `address`, `status`, `role`, `created_at`, `updated_at`) VALUES
(6, 'Trần Thị Thuỳ An', 'user@gmail.com', '$2y$10$gdKl/G0ViWEhb/iukvaCeO43/cqIgPVEh1ufgNcUbvEgaXNcVUJ4q', NULL, '0828212825', 'Sài Gòn', 'Active', 'Admin', '2024-07-12 09:18:25', NULL),
(7, 'a', 'a@gmail.com', '$2y$10$TZQzl2BmqVUs0nFM2GBrBOqOp1LCjfBJAxCtEuhzwrDJDOh7lK8hu', NULL, 'a', 'a', 'Active', 'Admin', '2024-07-12 09:21:55', NULL),
(8, 'Lê Đình Dũng', 'admin@gmail.com', '$2y$10$jE1REx5/mWlq92NFI1skeO/mTgdhdABxjsd39QrIeRHpXxlyWCIn6', NULL, '0828212825', 'Bình Dương', 'Active', 'Admin', '2024-07-12 09:30:21', NULL);
...
(3, 'SAMSUNG', 'samsung', 'Active', '2024-07-07 09:09:20', NULL),
(4, 'APPLE', 'apple', 'Active', '2024-07-07 09:09:18', NULL),
(5, 'No', 'no', 'Active', '2024-07-07 09:10:20', NULL);
...
(1, 'Bánh kẹo đường', 'banh-keo-duong', 'Active', '2024-07-07 12:25:17', NULL),
(2, 'Nem chả Quảng Ngãi', 'nem-cha-quang-ngai', 'Active', NULL, NULL),
(3, 'Đặc sản mắm', 'dac-san-mam', 'Active', NULL, NULL),
(4, 'Hành - tỏi - quế', 'hanh-toi-que', 'Active', NULL, NULL),
(5, 'Đặc sản khô', 'dac-san-kho', 'Active', NULL, NULL),
(6, 'Rau biển', 'rau-bien', 'Active', NULL, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `guide_products`
--
...
CREATE TABLE `news` (
  ...
  `sumary` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `newscategories` (
  ...
  `slug` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `status` enum('Active','Innactive') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Danh mục A', 'danh-muc-a', 'Active', '2024-07-07 15:53:55', NULL),
...
INSERT INTO `orders` (`id`, `us_ID`, `firstname`, `address`, `phone`, `email`, `status`, `created_at`, `updated_at`) VALUES
(31, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'admin@gmail.com', 'Processing', '2024-07-13 07:51:56', '2024-07-13 07:51:56'),
(32, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'admin@gmail.com', 'Delivered', '2024-07-13 08:04:20', '2024-07-13 08:04:20'),
(33, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'admin@gmail.com', 'Processing', '2024-07-13 08:19:09', '2024-07-13 08:19:09'),
(34, 6, 'Trần Thị Thuỳ An', 'Sài Gòn', '0828212825', 'user@gmail.com', 'Processing', '2024-07-13 08:57:19', '2024-07-13 08:57:19'),
(35, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'dung002.net@gmail.com', 'Processing', '2024-07-13 16:45:42', '2024-07-13 16:45:42'),
(36, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'dung002.net@gmail.com', 'Processing', '2024-07-13 16:46:17', '2024-07-13 16:46:17'),
(37, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'dung002.net@gmail.com', 'Processing', '2024-07-13 16:47:51', '2024-07-13 16:47:51'),
(38, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'dung002.net@gmail.com', 'Processing', '2024-07-13 16:54:07', '2024-07-13 16:54:07'),
(39, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'dung002.net@gmail.com', 'Processing', '2024-07-13 16:56:06', '2024-07-13 16:56:06'),
(40, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'dung002.net@gmail.com', 'Processing', '2024-07-13 17:01:29', '2024-07-13 17:01:29'),
(41, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'admin@gmail.com', 'Processing', '2024-07-13 17:04:07', '2024-07-13 17:04:07'),
(43, 8, 'Lê Đình Dũng', 'Bình Dương', '0828212825', 'dung002.net@gmail.com', 'Processing', '2024-07-13 17:09:37', '2024-07-13 17:09:37');
...
(24, 31, 13, 45000, 1, 45000, '2024-07-13 07:51:56', '2024-07-13 07:51:56'),
(25, 32, 28, 120000, 1, 120000, '2024-07-13 08:04:20', '2024-07-13 08:04:20'),
(26, 33, 28, 120000, 3, 360000, '2024-07-13 08:19:09', '2024-07-13 08:19:09'),
(27, 34, 13, 45000, 1, 45000, '2024-07-13 08:57:19', '2024-07-13 08:57:19'),
(28, 34, 20, 35000, 1, 35000, '2024-07-13 08:57:19', '2024-07-13 08:57:19'),
(29, 34, 21, 888888, 1, 888888, '2024-07-13 08:57:19', '2024-07-13 08:57:19'),
(30, 35, 18, 80000, 1, 80000, '2024-07-13 16:45:42', '2024-07-13 16:45:42'),
(31, 36, 18, 80000, 1, 80000, '2024-07-13 16:46:17', '2024-07-13 16:46:17'),
(32, 37, 17, 12000, 1, 12000, '2024-07-13 16:47:51', '2024-07-13 16:47:51'),
(33, 38, 13, 45000, 1, 45000, '2024-07-13 16:54:07', '2024-07-13 16:54:07'),
(34, 39, 17, 12000, 1, 12000, '2024-07-13 16:56:06', '2024-07-13 16:56:06'),
(35, 40, 27, 75000, 1, 75000, '2024-07-13 17:01:29', '2024-07-13 17:01:29'),
(36, 41, 28, 120000, 1, 120000, '2024-07-13 17:04:07', '2024-07-13 17:04:07'),
(37, 43, 28, 120000, 1, 120000, '2024-07-13 17:09:37', '2024-07-13 17:09:37');
...
(29, 'Cá bống sông Trà', 'ca-bong-song-tra', '                                                                        Đây là món ăn đặc trưng, cá bống được đánh bắt ở sông về làm sạch và rim sau đó cho vào hộp để bán làm quà. Có nhiều loại cá bống như cá bống cát, cá bống tượng... \r\n                                                                                                ', '                                                                        Cá bống sông Trà là món ăn đặc trưng hay được sử dụng làm quà khi khách ghé thăm Quảng Ngãi.                                                                        ', 255, 99999, 99900, 'uploads/6547a7198a1f4ca_bong_song_tra.png', 3, 5, 'Active', NULL, NULL),
(30, 'Rau cau - chân vịt', 'rau-cau---chan-vit', '                                                \r\nsf\r\n3	3	4	5\r\n 	 	 	 \r\n5	 	5	 \r\n 	5	 	 \r\n 	5	 	5\r\n\r\n \r\ndfsdff\r\n\r\nsdfsf\r\n\r\nsdfsd\r\n\r\n    Con gì thế\r\n\r\n                                                ', '                        Racc ff                        ', 3, 80000, 30000, 'uploads/654cb196e540arau-cau.png', 6, 5, 'Active', '2024-07-13 15:17:12', NULL);
...
--
-- Chỉ mục cho bảng `guide_products`
--
ALTER TABLE `guide_products`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT cho bảng `guide_products`
--
ALTER TABLE `guide_products`
...
--
-- Các ràng buộc cho bảng `guide_products`
--
ALTER TABLE `guide_products`
  ADD CONSTRAINT `guide_products_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `guide_products_ibfk_2` FOREIGN KEY (`us_id`) REFERENCES `admins` (`id`);

--
-- Các ràng buộc cho bảng `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`us_ID`) REFERENCES `admins` (`id`);
