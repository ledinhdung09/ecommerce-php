...
$slug = strtolower(trim(preg_replace('/[^A-Za-z0-9-]+/', '-', $name_no_accents)));
    ...
    $sql_str2 = "update brands set name='$name', slug='$slug',created_at= now() where id=$id";
    
    mysqli_query($conn, $sql_str2);
    
    //chuyen qua trang listbrands
    header("location: ../danh-sach-thuong-hieu-san-pham");
} else {
                        ...
                        <form class="user" method="post" action="">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="name" name="name"
                                    aria-describedby="emailHelp" placeholder="Tên thương hiệu"
